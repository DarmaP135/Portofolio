            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form">
                    ...
                    <div class="mb-3">
                        ...
                        <x-jet-input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" placeholder="Masukkan Email" type="email" name="email" :value="old('email')" required style="border-radius: 15px; border-color: #E9EBFF;height:50px;width: 370px; margin-left: 40px;" />
                    ...
                    <div class="mb-3">
                        ...
                        <x-jet-input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" placeholder="Masukkan Password" type=" password" name="password" required autocomplete="current-password" style="border-radius: 15px; border-color: #E9EBFF;height:50px;width: 370px; margin-left: 40px;" />
                ...
                <div class="login100-more">
                    <div class="container">
                        ...
                        <p class="text-center">Bantu kamu mengatur jadwal kegiatanmu sehari-hari dengan
                            mudah.
